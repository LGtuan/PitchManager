...
public class ManHinhCaNhanFragment extends Fragment {
    ...
    public static ManHinhCaNhanFragment newInstance(String param1, String param2) {
        ManHinhCaNhanFragment fragment = new ManHinhCaNhanFragment();
